...
# MCMC files
include("MCMC/Model Sampling/initalisers.jl")
...
include("MCMC/Model Sampling/imcmc_SIM_proportional.jl")
include("MCMC/Model Sampling/imcmc_SIM_gibbs.jl")
include("MCMC/Model Sampling/imcmc_SIM_subpath.jl")
...
include("MCMC/Posterior Sampling/iex_SIM_proportional.jl")
